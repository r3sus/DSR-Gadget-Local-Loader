...
namespace DSR_Gadget
{
    public partial class ColorSelectorEye : Form
    {
        ...
        public ColorSelectorEye(DSRPlayer player)
        {
            InitializeComponent();
        ...
        private bool SetGlowStatus()
        {
            ...
            if (Player.EyeRed > 1 || Player.EyeGreen > 1 || Player.EyeBlue > 1)
        ...
        {
            Player.EyeRed = cbxGlow.Checked ? (float)((nudRed.Value / 255) * 10) : (float)(nudRed.Value / 255);
            Player.EyeGreen = cbxGlow.Checked ? (float)((nudGreen.Value / 255) * 10) : (float)(nudGreen.Value / 255);
            Player.EyeBlue = cbxGlow.Checked ? (float)((nudBlue.Value / 255) * 10) : (float)(nudBlue.Value / 255);
        }
